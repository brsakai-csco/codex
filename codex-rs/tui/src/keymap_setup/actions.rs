...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "toggle_permission_mode", "Toggle between Ask for Approval and Read Only."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "toggle_permission_mode") => Some(&mut keymap.global.toggle_permission_mode),
